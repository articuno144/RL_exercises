    ...
    def get_reachable(self, x, observed=None, plot=False):
        ...
        while to_visit != set():
            ...
            if not trail_entering and variable not in observed:
                # add ancesstors and decendents to to_visit, with directions
            # ---> V
            elif trail_entering:
                # add decendents to to_visit with directions if V not observed
                # add ancestors to to_visit if V in ancestors or observed, with directions
